...
form.addEventListener("submit", (e)=>{
  // the defaut behavior of a form is to submit to some kind of server
  // we can prevent this by using the e.preventDefault()
  e.preventDefault();
  ...
  if(isNaN(value) || value <= 0 ||value > 9){
    ...
    // making a copy of the text array using the slice operator
